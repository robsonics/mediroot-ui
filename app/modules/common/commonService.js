(function () {
    ...
    //    .constant('ApiAdress', 'http://192.168.1.200:8081')
...
<button type="button" class="ngdialog-button ngdialog-button-primary" ng-click="confirm(1)">' + confirmResponse + '</button>\
        ...
        .factory('PatientAPI', ['$http', 'ApiAdress', function ($http, ApiAdress) {
            return {
                getCountryAdress: function () {
                    return $http.get(ApiAdress + '/patient/country/', { cache: true});
                },
                getCityPostal: function () {
                    return $http.get(ApiAdress + '/patient/city/postal/', { cache: true});
                },
                ...
                addPatient: function (patient) {
                    return $http.post(ApiAdress + '/patient/add', patient);
                },
                patientDetails: function (patientId) {
                    return $http.get(ApiAdress + '/patient/' + patientId + '/details');
                }
            };
        }])
